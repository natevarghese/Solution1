...
#ifndef MAPBOX_BINDINGS_OBJC_SWIFT_H
#define MAPBOX_BINDINGS_OBJC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Mapbox_Bindings_Objc",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC20Mapbox_Bindings_Objc6LatLng")
...
SWIFT_CLASS("_TtC20Mapbox_Bindings_Objc9MapBounds")
...
SWIFT_CLASS("_TtC20Mapbox_Bindings_Objc21MapInitOptionsFactory")
@interface MapInitOptionsFactory : NSObject
+ (MapInitOptions * _Nonnull)createWithAccessToken:(NSString * _Nonnull)accessToken style:(NSString * _Nonnull)style centerLat:(double)centerLat centerLon:(double)centerLon zoom:(double)zoom SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC20Mapbox_Bindings_Objc14MapViewFactory")
@interface MapViewFactory : NSObject
@property (nonatomic, copy) void (^ _Nullable emitLog)(NSString * _Nullable);
@property (nonatomic, copy) void (^ _Nullable mapLoaded)(MapView * _Nullable);
@property (nonatomic, copy) void (^ _Nullable styleLoaded)(MapView * _Nullable);
@property (nonatomic, copy) void (^ _Nullable cameraChanged)(MapView * _Nullable);
@property (nonatomic, copy) void (^ _Nullable viewportUpdate)(BOOL);
@property (nonatomic, copy) void (^ _Nullable locationUpdate)(LatLng * _Nullable);
@property (nonatomic, copy) void (^ _Nullable locationAnimationCompleted)(MapView * _Nullable);
- (MapView * _Nonnull)createWithFrame:(CGRect)frame mapInitOptions:(MapInitOptions * _Nonnull)mapInitOptions SWIFT_WARN_UNUSED_RESULT;
...
- (CGPoint)CoordinatePointAtPointWithMapView:(MapView * _Nonnull)mapView point:(CGPoint)point SWIFT_WARN_UNUSED_RESULT;
- (MapBounds * _Nonnull)getBoundsWithMapView:(MapView * _Nonnull)mapView SWIFT_WARN_UNUSED_RESULT;
- (BOOL)styleImageExistsWithMapView:(MapView * _Nonnull)mapView id:(NSString * _Nonnull)id SWIFT_WARN_UNUSED_RESULT;
- (void)addStyleImageWithMapView:(MapView * _Nonnull)mapView id:(NSString * _Nonnull)id base64:(NSString * _Nonnull)base64;
- (NSArray<NSString *> * _Nonnull)getAllLayerIdentifiersWithMapView:(MapView * _Nonnull)mapView SWIFT_WARN_UNUSED_RESULT;
- (void)removeLayerWithMapView:(MapView * _Nonnull)mapView id:(NSString * _Nonnull)id;
- (BOOL)layerExistsWithMapView:(MapView * _Nonnull)mapView id:(NSString * _Nonnull)id SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)sourceExistsWithMapView:(MapView * _Nonnull)mapView id:(NSString * _Nonnull)id SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSString *> * _Nonnull)getAllSourceIdentifiersWithMapView:(MapView * _Nonnull)mapView SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC20Mapbox_Bindings_Objc20OfflineManagerBridge")
